...
bandasRegistradas.Add("Linkin Park", new List<int> { 5, 3, 4, });
...
{
    Console.Clear();
    ExibirTituloDaOpcao("Regsitro das Bandas");
...
void AvaliarUmaBanda()
{
    ...
    if (bandasRegistradas.ContainsKey(nomeDaBanda))
    {
        ...
        bandasRegistradas[nomeDaBanda].Add(note);
        Console.WriteLine($"\nA nota {note} foi registrada com sucesso para a banda {nomeDaBanda}");
        Thread.Sleep(4000);
        Console.Clear();
        ExibirLogo();
        ExibirOpcoesDoMenu();
...
void ExibirMediaDaBanda(){
    Console.Clear();
    ExibirTituloDaOpcao("Exibir média das notas da banda");
